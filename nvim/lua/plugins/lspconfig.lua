  ...
  config = function()
    ...
    local servers = {
      ...
      gopls = {
        settings = {
          gopls = {
            buildFlags = { '-tags=e2e' },  -- TODO: check if stil needed
          },
        },
      },
      pyright = {},
    ...
    require('neodev').setup() -- TODO: still needed? Setup neovim lua configuration
    ...
    -- TODO: Still necessary? Turn on lsp status information
